 ...
 *
 * @param lista puntero al primer node de la lista
 *
 */
 ...
 * @param cadena puntero a la cadena con la que se creara el nuevo nodo
 *
 * @return Retorna el mismo puntero lista o un puntero al nuevo elemento creada
 ...
 *
 * @param lista puntero al primer nodo de la lista
 * @param cadena puntero a la cadena que se desea verificar si es parte de algun
 * nodo
 *
 ...
 *
 * @param lista puntero al primer nodo de la lista
 * @param pos entero que indica la posicion en la que se desea ingresar el
 * elemento (0 es antes del primer elemento)
 * @param cadena puntero a la cadena para crear el nuevo nodo
 *
 * @return Puntero al primer elemento de la lista
 */
TipoNodoNombre *insertar_en_posicion(TipoNodoNombre *lista, int pos,
                                     char *cadena);

/** @brief Modifica el valor de una posicion
 *
 * @param lista puntero al primer nodo de la lista
 * @param pos entero a la posicion que se desea modifica (primer nodo posicion
 * 0)
 ...
 *
 * @return Retorna un puntero al primer nodo de una nueva lista con los nodos de
 * a y b
 */
