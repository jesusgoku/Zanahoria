...
*
* Hay funciones para pedir memoria facilmente para una matriz en una sola llamada y liberarla tambien.
*
* Para solicitar la memoria se utiliza un metodo para reducir el numero de llamadas a malloc solo a dos
* Lo cual lo hace eficiente en tiempo de procesador, pero como la memoria solicitada debe ser continua
* se corre el riesgo de no encontrar el suficiente espacio para la matriz, este riesgo se reduce al pedir
* la memoria de cada fila por separado, pero considerando que los computadores actuales tienen suficiente
* memoria opte por utilizar este metodo.
*
* @file memoria.h
* @version 0.1
* @date 22/04/2012
...
*
* Te permite pedir memoria para una matriz de entre 3 tipos (Enteros, Caracteres, Flotantes) especificandolo
...
*			f -> float
*
* @return Puntero a la matriz solicitad, se debe hacer un casting al tipo pedido
*/
