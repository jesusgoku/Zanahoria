...
void fijarColorNormal() { printf("\033[0m"); }

void fijarColorTexto(const int color) { printf("\033[0;%im", color); }

void fijarColorFondo(const int fondo) { printf("\033[0;%im", fondo); }

void fijarColorEstilo(const int estilo) { printf("\033[%im", estilo); }
