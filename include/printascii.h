...
/** @brief Imprimir un mesaje de error en color rojo e introducir una pausa en
 * la ejecucion
 *
...
/** @brief Imprimir un mesaje de confirmacion en color verde e introducir una
...
/** @brief Imprimir un mesaje de informacion en color marron e introducir una
 * pausa en la ejecucion
 *
 * @param msj puntero a cadena con el mensaje a mostrar
 */
